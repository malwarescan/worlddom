...
export function DesignFooter() {
  ...
  return (
    <footer className="bg-white border-t border-gray-100">
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-500 max-w-xs">
              Transforming businesses with cutting-edge AI solutions and innovative digital strategies.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center">
          <p className="text-xs text-gray-500">&copy; {currentYear} Neural Command. All rights reserved.</p>
